...
java -cp $(hbase classpath):/home/ec2-user/denny/HBaseImport/target/HBaseImport-0.0.1-SNAPSHOT-jar-with-dependencies.jar com.dennyac.HBaseImport.TopSongsYearwise > ${LOG_PATH}/load_hbase_data_${dt}.log 2>&1 
